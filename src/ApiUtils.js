...
export const BACKEND_POST_BASE_URL = "http://localhost:8080/ubuntu/post";
export const BACKEND_BASE_URL = "http://localhost:8080";
export const BACKEND_CHATROOM_BASE_URL = "http://localhost:8080/ubuntu/chatroom";
export const BACKEND_COMMUNITY_MANAGER_BASE_URL = "http://localhost:8080/api/v1/community_manager"
export const BACKEND_COMMENT_BASE_URL = "http://localhost:8080/ubuntu/comment";
